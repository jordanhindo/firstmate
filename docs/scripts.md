...
| `fm-company-pause-lib.sh` | Shared runtime-shell consumer of the company-owned pause-mode reader, gating business admission at spawn, startup, and supervision |
